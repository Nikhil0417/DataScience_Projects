...
train_size.append((y_train.shape[0]/14980)*100)
# cross validation for DT
tt0=time()
print("cross-validation result for DT")
scores_dt = cross_validation.cross_val_score(dt, df[features], df.iloc[:,14], cv=5)
print(scores_dt)
...
scores_rf = cross_validation.cross_val_score(rf, df[features], df.iloc[:,14], cv=5)
print(scores_rf)
...
scores_nb = cross_validation.cross_val_score(nb, df[features], df.iloc[:,14], cv=5)
print(scores_nb)
...
scores_knn = cross_validation.cross_val_score(knn, df[features], df.iloc[:,14], cv=5)
print(scores_knn)
...
tt01=time()
print("cross-validation result for DT")
scores_dt1 = cross_validation.cross_val_score(dt1, X_PCA, df.iloc[:,14], cv=5)
print(scores_dt1)
...
tt21=time()
print("cross-validation result for RF")
scores_rf1 = cross_validation.cross_val_score(rf1, X_PCA, df.iloc[:,14], cv=5)
print(scores_rf1)
...
tt41=time()
print("cross-validation result for NB")
scores_nb1 = cross_validation.cross_val_score(nb1, X_PCA, df.iloc[:,14], cv=5)
print(scores_nb1)
...
tt61=time()
print("cross-validation result for K-NN")
scores_knn1 = cross_validation.cross_val_score(knn1, X_PCA, df.iloc[:,14], cv=5)
print(scores_knn1)
...
tt02=time()
print("cross-validation result for DT")
scores_dt2 = cross_validation.cross_val_score(dt2, X_kpca, df.iloc[:,14], cv=5)
print(scores_dt2)
...
tt22=time()
print("cross-validation result for RF")
scores_rf2 = cross_validation.cross_val_score(rf2, X_kpca, df.iloc[:,14], cv=5)
print(scores_rf2)
...
tt42=time()
print("cross-validation result for NB")
scores_nb2 = cross_validation.cross_val_score(nb2, X_kpca, df.iloc[:,14], cv=5)
print(scores_nb2)
...
tt62=time()
print("cross-validation result for K-NN")
scores_knn2 = cross_validation.cross_val_score(knn2, X_kpca, df.iloc[:,14], cv=5)
print(scores_knn2)
...
ax.set_title('Accuracy comparison on EEG Eye-state Data')
...
ax.set_title('Computation time comparison on EEG Eye-state Data')
plt.xticks(index+bar_width, ('DT', 'RF', 'NB', 'K-NN'))
...
plt.title('5-fold Cross Validation on EEG Eye-state Data')
plt.show()
